      ...
      <AnimatePresence>
        {isSearchOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] bg-[#F8F6F0] flex flex-col"
          >
            <div className="px-5 py-4 flex items-center gap-4 border-b border-black/[0.03]">
              ...
              <motion.button
                ...
                className="w-10 h-10 rounded-xl bg-white border border-[#E5E7EB] flex items-center justify-center text-[#1A1A1A]"
              >
                <X size={20} />
              </motion.button>
            </div>
